 ...
 * <p>&nbsp;</p>
 * To be used via {@link htk.photoview.PhotoViewAttacher#setOnDoubleTapListener(GestureDetector.OnDoubleTapListener)}
 */
        ...
        if (null != photoViewAttacher.getOnPhotoTapListener()) {
            ...
            if (null != displayRect) {
                ...
                if (displayRect.contains(x, y)) {
                    ...
                    photoViewAttacher.getOnPhotoTapListener().onPhotoTap(imageView, xResult, yResult, e.getX(), e.getY());
                    return true;
                }
            }
        }
